...
class OrderController extends Controller implements HasMiddleware
{
    ...
    public function selectMarketerInfo($marketeId)
    {
        ...
        $returned = $this->orderService->selectMarketerInfo($marketeId);
    ...
    public function selectAddressInfo($addressId)
    {
        ...
        $returned = $this->orderService->selectAddressInfo($addressId);
        return response()->format($returned, 'messages.success', 200);
    }
    ...
    public function selectZoneProducts($zoneId)
    {
        ...
        $returned = $this->orderService->selectZoneProducts($zoneId);
        return response()->format($returned, 'messages.success', 200);
    }
    ...
    public function selectZoneOffers($zoneId)
    {
        ...
        $returned = $this->orderService->selectZoneOffers($zoneId);
        return response()->format($returned, 'messages.success', 200);
    }
    ...
    public function warehouseProducts($warehouseId)
    {
        ...
        $returned = $this->orderService->warehouseProducts($warehouseId);
        return response()->format($returned, 'messages.success', 200);
    }
    ...
    public function warehouseOffers($warehouseId)
    {
        ...
        $returned = $this->orderService->warehouseOffers($warehouseId);
        return response()->format($returned, 'messages.success', 200);
    }
