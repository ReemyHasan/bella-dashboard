...
class AddressService
{
    ...
    {
        return Address::with('deliveryMan', 'alterDeliveryMan', 'region')->filterBy($request->all())
    ...
    public function create(array $data)
    {
        return DB::transaction(function () use ($data) {
            ...
            $address->load('deliveryMan', 'alterDeliveryMan', 'region');
    ...
    {
        $address->load('deliveryMan', 'alterDeliveryMan', 'region.city.zone');
        return $address;
    }
